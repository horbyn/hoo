 ...
 **************************************************************************/
#pragma once
#ifndef __KERN_DRIVER_ATA_ATA_IDENTIFY_DATA_H__
#define __KERN_DRIVER_ATA_ATA_IDENTIFY_DATA_H__
...
const char *ata_print_string(const void *buff, uint32_t bufflen);
